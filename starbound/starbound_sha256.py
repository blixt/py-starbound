# IMPORTANT! This module has been modified to *not* follow the standard SHA-256
# algorithm. It will switch the padlen at 55 instead of 56, because that is how
# Starbound does it in their implementation.
# Modified by Blixt <me@blixt.org>
